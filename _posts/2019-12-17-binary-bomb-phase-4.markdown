...
Combine the complete func4 code into a text file with the above code pasted beneath it, and save it as phase_4.py.  Run it by navigating to the directory in which you saved the file, and type python phase_4.py.
